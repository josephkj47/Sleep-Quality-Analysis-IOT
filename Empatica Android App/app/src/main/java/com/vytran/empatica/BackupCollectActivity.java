...
/** Backup file from empatica github */
public class BackupCollectActivity extends AppCompatActivity implements EmpaDataDelegate, EmpaStatusDelegate {
//private class CollectSleepDataActivity extends AppCompatActivity implements EmpaDataDelegate, EmpaStatusDelegate {
    ...
    public void didDiscoverDevice(EmpaticaDevice bluetoothDevice, String deviceName, int rssi, boolean allowed) {
        ...
        if (allowed) {
            ...
            try {
                ...
                Toast.makeText(BackupCollectActivity.this, "Sorry, you can't connect to this device", Toast.LENGTH_SHORT).show();
